...
* There is a way for special interests to find the right price of individual US Representatives for an issue of interest: all it takes is a simple logit regression and some simulation.
